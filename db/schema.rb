...
ActiveRecord::Schema.define(version: 20170823164532) do
  ...
  add_index "dashboards", ["shoe_id"], name: "index_dashboards_on_shoe_id", using: :btree
  ...
  add_foreign_key "dashboards", "shoes"
